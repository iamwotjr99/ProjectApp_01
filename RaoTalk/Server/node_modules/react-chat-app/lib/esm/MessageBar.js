...
import { B as Button } from './index-d7bca72b.js';
import './_rollupPluginBabelHelpers-1b8c042f.js';
...
`;
const StyledPopoverContent = Ye.div`
  display: flex;
  & > * {
    display: flex;
    margin: 0 8px;
...
`;
const styledMessageBar = Ye.footer`
  padding: 12px 30px;
  width: 100%;
`;
...
function MessageBar({
  ...
  return /*#__PURE__*/React__default.createElement(styledMessageBar, rest, /*#__PURE__*/React__default.createElement(Input, {
    placeholder: "Please input....",
    prefix: /*#__PURE__*/React__default.createElement(Icon, {
      icon: prefixIcon
    }),
    suffix: /*#__PURE__*/React__default.createElement(IconContainer, null, /*#__PURE__*/React__default.createElement(Popover, {
      content: PopoverContent && /*#__PURE__*/React__default.createElement(StyledPopoverContent, null, /*#__PURE__*/React__default.createElement(PopoverContent, null)),
      offset: {
        x: '-25%'
      },
      ...
      icon: icon3
    }), MessageButton && /*#__PURE__*/React__default.createElement(MessageButton, null))
  }));
}
