...
public class MainActivity extends AppCompatActivity {
    ...
    public void onButton305Clicked(View v) {
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/oksanseowon_nangman_coffee?igshid=1ach2d57lyms0"));
        startActivity(myIntent); }
    public void onButton306Clicked(View v) {
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://map.naver.com/v5/search/%EC%95%88%EA%B0%95%EC%9D%8D%20%EC%B9%B4%ED%8E%98/place/1053369020?c=14378025.2082202,4302470.1235434,18,0,0,0,dh"));
        startActivity(myIntent); }
